	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<p class="description"><?php _e( 'For more information on WordPress roles and capabilities please see <a href="http://codex.wordpress.org/Roles_and_Capabilities" target="_blank">http://codex.wordpress.org/Roles_and_Capabilities</a>.', 'it-l10n-ithemes-security-pro' ); ?>
			</td>
		</tr>
		<tr>
