...
class ITSEC_Settings_Page_Sidebar_Widget_Pro_Upsell extends ITSEC_Settings_Page_Sidebar_Widget {
	...
	public function render( $form ) {
		...
		echo '</ul>';
		echo '<a href="https://ithemes.com/security/?utm_source=wordpressadmin&utm_medium=widget&utm_campaign=itsecfreecta" class="button-primary" target="_blank">' . __( 'Get iThemes Security Pro', 'it-l10n-ithemes-security-pro' ) . '</a>';
	}
