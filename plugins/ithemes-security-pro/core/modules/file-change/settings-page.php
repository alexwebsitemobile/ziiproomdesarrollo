...
final class ITSEC_File_Change_Settings_Page extends ITSEC_Module_Settings_Page {
	...
	public function enqueue_scripts_and_styles() {
		...
		$vars = array(
			...
			'found_changes'        => sprintf( __( 'Changes were detected. Please check the <a href="%s" target="_blank">logs page</a> for details.', 'it-l10n-ithemes-security-pro' ), esc_url( $logs_page_url ) ),
			'unknown_error'        => __( 'An unknown error occured. Please try again later', 'it-l10n-ithemes-security-pro' ),
			'already_running'      => sprintf( __( 'A scan is already in progress. Please check the <a href="%s" target="_blank">logs page</a> at a later time for the results of the scan.', 'it-l10n-ithemes-security-pro' ), esc_url( $logs_page_url ) ),
