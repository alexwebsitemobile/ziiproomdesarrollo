	...
	<table class="form-table itsec-settings-section">
		...
		<tr>
			...
			<td>
				...
				<p><a href="http://ip-lookup.net/domain-lookup.php" target="_blank"><?php _e( 'Lookup IP Address.', 'it-l10n-ithemes-security-pro' ); ?></a></p>
		...
		<tr>
			...
			<td>
				...
				<label for="itsec-global-log_type"><?php _e( 'How should even logs be kept', 'it-l10n-ithemes-security-pro' ); ?></label>
		...
		<?php if ( is_dir( WP_PLUGIN_DIR . '/iwp-client' ) ) : ?>
			<tr>
				...
				<td>
					...
					<p class="description"><?php printf( __( 'Turning this feature on will enable compatibility with <a href="%s" target="_blank">InfiniteWP</a>. Do not turn it on unless you use the InfiniteWP service.', 'it-l10n-ithemes-security-pro' ), 'http://infinitewp.com' ); ?></p>
				</td>
			</tr>
		<?php endif; ?>
		<tr>
